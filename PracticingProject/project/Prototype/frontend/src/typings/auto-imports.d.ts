...
declare global {
  ...
  const fetchAssignOrgTagsToUser: typeof import('../service/api/admin').fetchAssignOrgTagsToUser
  const fetchChangePassword: typeof import('../service/api/auth').fetchChangePassword
  const fetchCreateAdminUser: typeof import('../service/api/admin').fetchCreateAdminUser
  const fetchCreateOrgTag: typeof import('../service/api/admin').fetchCreateOrgTag
  const fetchCustomBackendError: typeof import('../service/api/auth').fetchCustomBackendError
  const fetchDeleteOrgTag: typeof import('../service/api/admin').fetchDeleteOrgTag
  const fetchGetAllOrgTags: typeof import('../service/api/admin').fetchGetAllOrgTags
  ...
  const fetchGetOrgTagTree: typeof import('../service/api/org-tag').fetchGetOrgTagTree
  const fetchGetUserInfo: typeof import('../service/api/auth').fetchGetUserInfo
  const fetchGetUserList: typeof import('../service/api/admin').fetchGetUserList
  const fetchGetUserRoutes: typeof import('../service/api/route').fetchGetUserRoutes
  const fetchGetUsers: typeof import('../service/api/admin').fetchGetUsers
  ...
  const fetchUpdateOrgTag: typeof import('../service/api/admin').fetchUpdateOrgTag
  ...
  const filterRoutesByDev: typeof import('../store/modules/route/shared').filterRoutesByDev
  ...
  const isDev: typeof import('../constants/env').isDev
  ...
  const reorderFixedTabs: typeof import('../store/modules/tab/shared').reorderFixedTabs
  ...
  const watermarkTimeFormatOptions: typeof import('../constants/app').watermarkTimeFormatOptions
...
declare global {
  ...
  import('naive-ui')
  // @ts-ignore
  export type { FlatResponseData } from '@sa/axios'
  import('@sa/axios')
  // @ts-ignore
  export type { FetchOrgTagTreeResult } from '../service/api/org-tag'
  import('../service/api/org-tag')
  // @ts-ignore
