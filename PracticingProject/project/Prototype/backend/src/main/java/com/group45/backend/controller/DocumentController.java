...
import com.group45.backend.service.ChatHandler;
...
public class DocumentController {
    ...
    public ResponseEntity<?> deleteDocument(
        ...
        try {
            ...
            // 权限检查：文件所有者、管理员或库管可以删除
            boolean isAdminOrLibraryAdmin = "ADMIN".equals(role) || "LIBRARY_ADMIN".equals(role);
            if (!file.getUserId().equals(userId) && !isAdminOrLibraryAdmin) {
