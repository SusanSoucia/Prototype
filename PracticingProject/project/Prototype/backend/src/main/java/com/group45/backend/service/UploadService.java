...
import com.group45.backend.config.MinioConfig;
import com.group45.backend.exception.CustomException;
import com.group45.backend.model.ChunkInfo;
...
public class UploadService {
    ...
    public String mergeChunks(String fileMd5, String fileName, String userId) {
        ...
        try {
            ...
            try {
                ...
                String presignedUrl = generateMergedObjectUrl(fileMd5, fileName);
    ...
    public String generateMergedObjectUrl(String fileMd5, String fileName) throws Exception {
        return minioClient.getPresignedObjectUrl(
                GetPresignedObjectUrlArgs.builder()
                        ...
                        .extraQueryParams(Map.of("response-content-disposition", "inline; filename=\"" + fileName + "\""))
                        .build()
        );
    }
