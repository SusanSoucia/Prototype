...
import com.group45.backend.model.DocumentVector;
...
public interface DocumentVectorRepository extends JpaRepository<DocumentVector, Long> {
    ...
    @Query("UPDATE DocumentVector d SET d.orgTag = :orgTag, d.isPublic = :isPublic WHERE d.fileMd5 = :fileMd5")
    int updatePermissionMetadataByFileMd5(@Param("fileMd5") String fileMd5,
