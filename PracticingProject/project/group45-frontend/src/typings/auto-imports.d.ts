...
declare global {
  ...
  const fetchAdminChatHistory: typeof import('../service/api/chat-history').fetchAdminChatHistory
  const fetchAssignOrgTagsToUser: typeof import('../service/api/user-management').fetchAssignOrgTagsToUser
  const fetchChangePassword: typeof import('../service/api/auth').fetchChangePassword
  const fetchChatHistory: typeof import('../service/api/chat-history').fetchChatHistory
  ...
  const fetchGetUserList: typeof import('../service/api/user-management').fetchGetUserList
...
declare global {
  ...
  import('@sa/axios')
  // @ts-ignore
  export type { ChatMessage, FetchChatHistoryParams } from '../service/api/chat-history'
  import('../service/api/chat-history')
  // @ts-ignore
